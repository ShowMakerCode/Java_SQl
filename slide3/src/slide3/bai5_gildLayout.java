 ...
 * @author 98tae
 */
public class bai5_gildLayout extends javax.swing.JFrame {

    /**
     * Creates new form bai5_gildLayout
     */
    public bai5_gildLayout() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bai5_gildLayout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bai5_gildLayout().setVisible(true);
            }
        });
    }
